...
plot(disc(radius=radius)); points(x, y)
...
ppxy <- ppp(x = x, y = y, window = disc(radius=10))
...
quadrat.test(p1, alternative="regular")
quadrat.test(p2, alternative="regular")
quadrat.test(p2, alternative="clustered")
quadrat.test(p1, alternative="clustered")
```
...
3. p1 is clustered, p2 is clustered (THIS SEEM TO BE THE RIGHT ONE!)
