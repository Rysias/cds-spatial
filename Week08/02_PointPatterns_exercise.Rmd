...
using a quadrat.test it seems that it is highly certain that the data is clustered. This is confirmed by the K-test as small numbers of R are more likely than expected
