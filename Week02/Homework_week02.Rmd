...
tm_shape(nz_elev)  +
  ...
  tm_compass(position = c("right", "top"),
             type = "rose", 
             size = 2) +
  tm_credits(text = "J. Rystroem, 2022-02-08") +
  # Change title
...
# What can you say about the content of this file? #
zion   # It is a single polygon with 11 fields (vector)

# What type of data does it store?  #
head(zion)  # A bunch of metadata, ids and relevant urls

# What is the coordinate system used? #
crs(zion) # It uses the GRS 1980 system

# How many attributes does it contain? #
# from inspecting we see it has 11 fields though there is a lot of redundant 
...
# What can you say about the content of this file? #
srtm   # It is a RasterLayer 

# What type of data does it store? #
# class, dimensions, resolution, crs, source, range 

# What is the coordinate system used? #
crs(srtm) # It uses the WGS84 system

# How many attributes does it contain? #
# Not any apart from the stuff 

# How many dimensions does it have? #
# 457 rows and 465 columns
...
# Reprojecting srtm with zion #
srtm2 <- srtm
crs(srtm2) <- crs(zion)
plot(srtm); plot(srtm2) # Looking at differences

# Reprojecting zion with srtm
zion2 <- st_transform(zion, crs(srtm))
plot(srtm);plot(zion2['UNIT_CODE'], borders="black", add=T)

# /End Code/ #
```

Looks weird AF but ¯\\_(ツ)_/¯ 
